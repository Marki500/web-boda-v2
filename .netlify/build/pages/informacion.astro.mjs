/* empty css                                 */
import { c as createComponent, r as renderTemplate, d as renderHead } from '../chunks/astro/server_cx-9Yj1i.mjs';
import 'kleur/colors';
import 'html-escaper';
import 'clsx';
import require$$6 from 'sqlstring';
...
import require$$5 from 'denque';
import require$$1 from 'lru-cache';
import require$$1$1 from 'buffer';
import require$$2 from 'long';
import require$$0 from 'iconv-lite';
import require$$0$2 from 'process';
import require$$0$1 from 'crypto';
import require$$0$3 from 'zlib';
import require$$2$1 from 'seq-queue';
import require$$3$1 from 'generate-function';
import require$$0$4 from 'url';
import require$$14 from 'named-placeholders';
...
const Iconv = require$$0;
const LRU$1 = require$$1.default;
...
const NativeBuffer = require$$1$1.Buffer;
...
class Handshake {
  ...
  setScrambleData(cb) {
    require$$0$1.randomBytes(20, (err, data) => {
      if (err) {
        cb(err);
        return;
      }
...
const $$Informacion = createComponent(async ($$result, $$props, $$slots) => {
  ...
  async function obtenerDatos() {
    ...
    let respuestasConNombres2 = [];
    let nombresDormir2 = [];
    let nombresInvitados2 = [];
    try {
    ...
    `);
      ...
      respuestasConNombres2 = respuestasConNombresData;
      nombresDormir2 = nombresDormirData;
      nombresInvitados2 = nombresInvitadosData;
    } catch (error) {
      console.error("Error al obtener datos de la base de datos:", error);
    } finally {
      await connection.end();
    }
    return { respuestasConNombres: respuestasConNombres2, nombresDormir: nombresDormir2, nombresInvitados: nombresInvitados2 };
  }
  const { respuestasConNombres, nombresDormir, nombresInvitados } = await obtenerDatos();
  return renderTemplate`<html data-astro-cid-udk54r6w> <head><title>Información de la Boda</title>${renderHead()}</head> <body data-astro-cid-udk54r6w> <div class="container" data-astro-cid-udk54r6w> <h1 data-astro-cid-udk54r6w>Respuestas del Formulario</h1> <table data-astro-cid-udk54r6w> <tr data-astro-cid-udk54r6w> <th data-astro-cid-udk54r6w>Asistencia</th> <th data-astro-cid-udk54r6w>Nombre de los Invitados</th> <th data-astro-cid-udk54r6w>Alergias</th> </tr> ${respuestasConNombres.map((respuesta) => renderTemplate`<tr data-astro-cid-udk54r6w> <td data-astro-cid-udk54r6w>${respuesta.attend ? "S\xED" : "No"}</td> <td data-astro-cid-udk54r6w>${respuesta.nombres}</td> <td data-astro-cid-udk54r6w>${respuesta.allergies}</td> </tr>`)} </table> <button onclick="window.location.href='/api/excel/descargar-respuestas'" data-astro-cid-udk54r6w>Descargar Respuestas</button> <h2 data-astro-cid-udk54r6w>Invitados que Pernoctarán</h2> <table data-astro-cid-udk54r6w> <tr data-astro-cid-udk54r6w> <th data-astro-cid-udk54r6w>Nombre</th> </tr> ${nombresDormir.map((persona) => renderTemplate`<tr data-astro-cid-udk54r6w> <td data-astro-cid-udk54r6w>${persona.nombre}</td> </tr>`)} </table> <button onclick="window.location.href='/api/excel/descargar-dormir'" data-astro-cid-udk54r6w>Descargar Invitados que Pernoctan</button> <h2 data-astro-cid-udk54r6w>Todos los Invitados</h2> <table data-astro-cid-udk54r6w> <tr data-astro-cid-udk54r6w> <th data-astro-cid-udk54r6w>Nombre</th> </tr> ${nombresInvitados.map((persona) => renderTemplate`<tr data-astro-cid-udk54r6w> <td data-astro-cid-udk54r6w>${persona.nombre}</td> </tr>`)} </table> <button onclick="window.location.href='/api/excel/descargar-invitados'" data-astro-cid-udk54r6w>Descargar Todos los Invitados</button> </div> </body></html>`;
}, "C:/Users/CCWEB1/Desktop/Marc/ULTIMA BODA/web-boda-v2/src/pages/informacion.astro", void 0);

const $$file = "C:/Users/CCWEB1/Desktop/Marc/ULTIMA BODA/web-boda-v2/src/pages/informacion.astro";
